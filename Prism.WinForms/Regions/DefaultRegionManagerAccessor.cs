...
namespace Prism.Regions
{
    internal class DefaultRegionManagerAccessor : IRegionManagerAccessor
    {
        ...
        public string GetRegionName(Control element)
        {
            if (element == null)
                throw new ArgumentNullException(nameof(element));

            //Todo: Store this token in an internal constant
            return TryGetConnectedProperty(element, "RegionName");
        }
        ...
        public IRegionManager GetRegionManager(Control element)
        {
            if (element == null)
                throw new ArgumentNullException(nameof(element));

            //Todo: Store this token in an internal constant
            return TryGetConnectedProperty(element, "RegionManager");
        }
