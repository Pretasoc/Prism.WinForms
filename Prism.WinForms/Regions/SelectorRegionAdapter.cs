...
namespace Prism.Regions
{
    ...
    /// </summary>
    public class SelectorRegionAdapter : RegionAdapterBase<ListControl>
    {
        /// <summary>
        ...
        protected override void Adapt(IRegion region, ListControl regionTarget)
        {
        }
        ...
        /// </remarks>
        protected override void AttachBehaviors(IRegion region, ListControl regionTarget)
        {
            if (region == null)
