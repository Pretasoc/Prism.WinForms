...
using Prism.Common;
using System;
using static Prism.Common.ConnectedPropertyHelpers;
...
namespace Prism.Regions
{
    ...
    public static class RegionContext
    {
        ...
        public static ObservableObject<object> GetObservableContext(Object view)
        {
            if (view == null)
                throw new ArgumentNullException(nameof(view));

            ObservableObject<object> context = TryGet< ObservableObject<object>>(view, "ObservableRegionContext");

            if (context == null)
            {
                context = new ObservableObject<object>();
                TrySet(view, "ObservableRegionContext", context);
